...
// change filterID to 1 to enable 0 to show all frames
const int filterID = 1;
// enter frameID that you want to print if above is set to 1
const uint8_t frameToShow = 0xf0;
...
if (frame.get_byte(0)== frameToShow || filterID == 0) {     
